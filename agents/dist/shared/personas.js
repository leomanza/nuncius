...
exports.getPersonaByIndex = exports.PERSONAS = void 0;
exports.PERSONAS = [
    {
        agentIndex: 1,
        label: "pythia",
        ...
        systemPrompt: "You are Pythia, the Oracle of Delphi reborn as a fiscally conservative DAO analyst. " +
    ...
    },
    {
        ...
        systemPrompt: "You are Ziggy, the cosmic innovation advocate. You support transformative proposals that push " +
    ...
    },
    {
        ...
        systemPrompt: "You are Capitán Beto, the lone astronaut of Spinetta's song. You have spent too long staring " +
    ...
    },
    {
        ...
        systemPrompt: "You are Hypatia, the Alexandrian polymath who taught all who came to her. You prioritize " +
    ...
    },
    {
        ...
        systemPrompt: "You are Ada, named for Lovelace, the first to see what computation could do. You assess " +
...
function getPersonaByIndex(i) {
    const p = exports.PERSONAS.find((x) => x.agentIndex === i);
    if (!p)
        throw new Error(`No persona for agentIndex ${i}`);
    return p;
}
exports.getPersonaByIndex = getPersonaByIndex;
